    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-6 py-12 bg-[var(--background)] warm-noise-bg relative">
      ...
      <Card className="w-full max-w-md premium-card shadow-lg relative z-10 overflow-hidden animated-border">
        ...
        <CardHeader
          ...
          description="Enter your email and we'll forward a recovery link."
        ...
        <CardBody className="pt-0 relative z-10">
          {successMessage ? (
            <div className="space-y-6 text-center">
              ...
              <Link
                href="/login"
                className="inline-block text-xs font-mono uppercase tracking-widest text-accent-primary hover:underline font-semibold transition-colors"
              >
                Return to sign in
              </Link>
            </div>
